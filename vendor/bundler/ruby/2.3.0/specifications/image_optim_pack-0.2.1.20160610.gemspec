# -*- encoding: utf-8 -*-
# stub: image_optim_pack 0.2.1.20160610 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<blockenspiel>, ["~> 0.4.0"])
      s.add_development_dependency(%q<rspec>, ["~> 3.0"])
      s.add_development_dependency(%q<rubocop>, ["~> 0.36"])
    else
      s.add_dependency(%q<image_optim>, ["~> 0.19"])
      s.add_dependency(%q<fspath>, ["~> 2.1"])
      s.add_dependency(%q<versionomy>, ["~> 0.4.4"])
      s.add_dependency(%q<blockenspiel>, ["~> 0.4.0"])
      s.add_dependency(%q<rspec>, ["~> 3.0"])
      s.add_dependency(%q<rubocop>, ["~> 0.36"])
    end
  else
    s.add_dependency(%q<image_optim>, ["~> 0.19"])
    s.add_dependency(%q<fspath>, ["~> 2.1"])
